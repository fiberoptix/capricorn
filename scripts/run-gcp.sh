...
# Service Account Key (stored in cloud/ - DO NOT commit to git)
...
deploy_k8s() {
    ...
    kubectl apply -f postgres-pvc.yaml 2>/dev/null
    kubectl apply -f redis-pvc.yaml 2>/dev/null
    sleep 5  # Wait for PVCs to be provisioned
