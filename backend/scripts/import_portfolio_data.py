...
if os.environ.get('DOCKER_CONTAINER'):
    DATABASE_URL = "postgresql+asyncpg://capricorn:REDACTED_DB_PASSWORD@capricorn-postgres:5432/capricorn_db"
else:
    DATABASE_URL = "postgresql+asyncpg://capricorn:REDACTED_DB_PASSWORD@localhost:5003/capricorn_db"
